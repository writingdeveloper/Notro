...
_PICKER_STRINGS = {
    "en": {
        ...
        "picker_auto_send": "Send automatically after pasting",
        "picker_auto_send_note": "Off by default. Notro presses Enter for you — make sure the right chat is focused.",
        "picker_edit_title": "Edit item",
        "picker_edit_note": "Separate keywords with spaces or commas. Leave the name blank to keep it.",
        "picker_edit_save": "Save",
        "picker_ctx_edit": "Rename / keywords…",
        "picker_err_duplicate": "You already have this image in this tab and collection.",
        "picker_drop_duplicate": "Already added ({duplicate} skipped).",
        "picker_paste_size": "Paste size",
        "picker_paste_size_note": "How large items look in Discord. 48 px matches a real custom emoji; 160 px matches a sticker.",
        "picker_size_original": "Original",
        ...
        "picker_hint": "Click / Enter = paste · ←↑↓→ = move · Esc = close · Right-click = more",
        "picker_add_title": "Add from Discord link",
        "picker_add_url_ph": "Paste a link or emoji text <:name:id>",
        "picker_add_name_ph": "Name (optional)",
        "picker_add_kw_ph": "Search keywords (optional)",
        "picker_add_collection_ph": "Collection (optional)",
        "picker_col_uncategorized": "Uncategorized",
        "picker_add_collection_new": "+ New collection…",
        "picker_add_collection_new_ph": "New collection name",
        "picker_add_note": "In Discord: right-click an emoji → Copy Link, or just copy the <:name:id> text from a message. Stickers without a link: save the image and drop the file here.",
        ...
        "picker_err_not_discord": "That's not a Discord emoji/sticker link or <:name:id> text.",
    ...
    "ko": {
        ...
        "picker_auto_send": "붙여넣은 뒤 자동으로 전송",
        "picker_auto_send_note": "기본적으로 꺼져 있습니다. Notro가 Enter를 대신 누르므로, 보낼 채팅창이 맞는지 확인하세요.",
        "picker_edit_title": "항목 수정",
        "picker_edit_note": "키워드는 공백이나 쉼표로 구분합니다. 이름을 비우면 기존 이름을 유지합니다.",
        "picker_edit_save": "저장",
        "picker_ctx_edit": "이름·키워드 수정…",
        "picker_err_duplicate": "이 탭·컬렉션에 같은 그림이 이미 있어요.",
        "picker_drop_duplicate": "이미 있는 항목이에요 ({duplicate}개 건너뜀).",
        "picker_paste_size": "붙여넣기 크기",
        "picker_paste_size_note": "디스코드에서 보이는 크기입니다. 48px이 실제 커스텀 이모지, 160px이 스티커와 같은 크기입니다.",
        "picker_size_original": "원본",
        ...
        "picker_hint": "클릭/Enter=붙여넣기 · ←↑↓→=이동 · Esc=닫기 · 우클릭=메뉴",
        "picker_add_title": "디스코드 링크로 추가",
        "picker_add_url_ph": "링크 또는 이모지 텍스트 <:이름:id> 붙여넣기",
        "picker_add_name_ph": "이름 (선택)",
        "picker_add_kw_ph": "검색 키워드 (선택)",
        "picker_add_collection_ph": "컬렉션 (선택)",
        "picker_col_uncategorized": "미분류",
        "picker_add_collection_new": "+ 새 컬렉션…",
        "picker_add_collection_new_ph": "새 컬렉션 이름",
        "picker_add_note": "디스코드에서 이모지 우클릭 → 링크 복사, 또는 메시지의 <:이름:id> 텍스트를 그대로 복사해 넣어도 됩니다. 링크가 없는 스티커는 이미지를 저장해 여기로 끌어다 놓으세요.",
        ...
        "picker_err_not_discord": "디스코드 이모지/스티커 링크나 <:이름:id> 텍스트가 아니에요.",
    ...
    "ja": {
        ...
        "picker_auto_send": "貼り付けたあと自動で送信",
        "picker_auto_send_note": "初期設定はオフです。Notro が Enter を代わりに押すので、送信先のチャットを確認してください。",
        "picker_edit_title": "項目を編集",
        "picker_edit_note": "キーワードは空白かカンマで区切ります。名前を空にすると元の名前のままです。",
        "picker_edit_save": "保存",
        "picker_ctx_edit": "名前・キーワードを編集…",
        "picker_err_duplicate": "このタブ・コレクションに同じ画像がすでにあります。",
        "picker_drop_duplicate": "すでに追加済みです（{duplicate}件スキップ）。",
        "picker_paste_size": "貼り付けサイズ",
        "picker_paste_size_note": "Discordでの表示サイズです。48pxが実際のカスタム絵文字、160pxがスタンプと同じ大きさです。",
        "picker_size_original": "元のサイズ",
        ...
        "picker_hint": "クリック/Enter=貼り付け · ←↑↓→=移動 · Esc=閉じる · 右クリック=メニュー",
        "picker_add_title": "Discord リンクから追加",
        "picker_add_url_ph": "リンクまたは絵文字テキスト <:名前:id> を貼り付け",
        "picker_add_name_ph": "名前（任意）",
        "picker_add_kw_ph": "検索キーワード（任意）",
        "picker_add_collection_ph": "コレクション（任意）",
        "picker_col_uncategorized": "未分類",
        "picker_add_collection_new": "+ 新しいコレクション…",
        "picker_add_collection_new_ph": "新しいコレクション名",
        "picker_add_note": "Discord で絵文字を右クリック → リンクをコピー、またはメッセージの <:名前:id> テキストをそのまま貼り付けても登録できます。リンクのないスタンプは画像を保存してここにドロップしてください。",
        ...
        "picker_err_not_discord": "Discord の絵文字/スタンプのリンクでも <:名前:id> テキストでもありません。",
    ...
    "zh": {
        ...
        "picker_auto_send": "粘贴后自动发送",
        "picker_auto_send_note": "默认关闭。Notro 会替你按下 Enter，请确认聚焦的是正确的聊天窗口。",
        "picker_edit_title": "编辑项目",
        "picker_edit_note": "关键词用空格或逗号分隔。名称留空则保持原样。",
        "picker_edit_save": "保存",
        "picker_ctx_edit": "修改名称/关键词…",
        "picker_err_duplicate": "该标签页和收藏集中已有相同图片。",
        "picker_drop_duplicate": "已经添加过了（跳过 {duplicate} 个）。",
        "picker_paste_size": "粘贴尺寸",
        "picker_paste_size_note": "在 Discord 中显示的大小。48 px 与真实自定义表情相同，160 px 与贴纸相同。",
        "picker_size_original": "原始尺寸",
        ...
        "picker_hint": "点击/Enter=粘贴 · ←↑↓→=移动 · Esc=关闭 · 右键=菜单",
        "picker_add_title": "通过 Discord 链接添加",
        "picker_add_url_ph": "粘贴链接或表情文本 <:名称:id>",
        "picker_add_name_ph": "名称（可选）",
        "picker_add_kw_ph": "搜索关键词（可选）",
        "picker_add_collection_ph": "合集（可选）",
        "picker_col_uncategorized": "未分类",
        "picker_add_collection_new": "+ 新建合集…",
        "picker_add_collection_new_ph": "新合集名称",
        "picker_add_note": "在 Discord 中右键表情 → 复制链接，也可以直接粘贴消息里的 <:名称:id> 文本。没有链接的贴纸请保存图片后拖到这里。",
        ...
        "picker_err_not_discord": "这不是 Discord 表情/贴纸链接或 <:名称:id> 文本。",
    ...
    "es": {
        ...
        "picker_auto_send": "Enviar automáticamente tras pegar",
        "picker_auto_send_note": "Desactivado de forma predeterminada. Notro pulsa Enter por ti: comprueba que el chat correcto tenga el foco.",
        "picker_edit_title": "Editar elemento",
        "picker_edit_note": "Separa las palabras clave con espacios o comas. Deja el nombre vacío para conservarlo.",
        "picker_edit_save": "Guardar",
        "picker_ctx_edit": "Renombrar / palabras clave…",
        "picker_err_duplicate": "Ya tienes esta imagen en esta pestaña y colección.",
        "picker_drop_duplicate": "Ya estaba añadido ({duplicate} omitidos).",
        "picker_paste_size": "Tamaño al pegar",
        "picker_paste_size_note": "Tamaño con el que se ven en Discord. 48 px equivale a un emoji personalizado real; 160 px, a un sticker.",
        "picker_size_original": "Original",
        ...
        "picker_hint": "Clic/Enter=pegar · ←↑↓→=mover · Esc=cerrar · Clic derecho=menú",
        "picker_add_title": "Añadir desde enlace de Discord",
        "picker_add_url_ph": "Pega un enlace o el texto de emoji <:nombre:id>",
        "picker_add_name_ph": "Nombre (opcional)",
        "picker_add_kw_ph": "Palabras clave (opcional)",
        "picker_add_collection_ph": "Colección (opcional)",
        "picker_col_uncategorized": "Sin clasificar",
        "picker_add_collection_new": "+ Nueva colección…",
        "picker_add_collection_new_ph": "Nombre de la colección",
        "picker_add_note": "En Discord: clic derecho en un emoji → Copiar enlace, o pega directamente el texto <:nombre:id> de un mensaje. Para stickers sin enlace, guarda la imagen y suéltala aquí.",
        ...
        "picker_err_not_discord": "No es un enlace de emoji/sticker de Discord ni texto <:nombre:id>.",
...
_VIDEO_STRINGS = {
    "en": {
        ...
        "video_trim_label": "Trim (mm:ss) — shorter means better quality",
        "video_trim_start_ph": "start",
        "video_trim_end_ph": "end",
        "video_mute": "Drop audio",
        "video_trim_invalid": "That range doesn't fit — try a shorter clip.",
    ...
    "ko": {
        ...
        "video_trim_label": "구간 자르기 (mm:ss) — 짧을수록 화질이 좋아져요",
        "video_trim_start_ph": "시작",
        "video_trim_end_ph": "끝",
        "video_mute": "오디오 제거",
        "video_trim_invalid": "이 구간은 한도 안에 못 넣어요 — 더 짧게 잘라 보세요.",
    ...
    "ja": {
        ...
        "video_trim_label": "切り出す範囲 (mm:ss) — 短いほど画質が上がります",
        "video_trim_start_ph": "開始",
        "video_trim_end_ph": "終了",
        "video_mute": "音声を削除",
        "video_trim_invalid": "この範囲では上限に収まりません — もっと短くしてください。",
    ...
    "zh": {
        ...
        "video_trim_label": "裁剪范围 (mm:ss) — 越短画质越好",
        "video_trim_start_ph": "开始",
        "video_trim_end_ph": "结束",
        "video_mute": "移除音频",
        "video_trim_invalid": "这个范围放不进限制 — 请再剪短一些。",
    ...
    "es": {
        ...
        "video_trim_label": "Recortar (mm:ss) — cuanto más corto, mejor calidad",
        "video_trim_start_ph": "inicio",
        "video_trim_end_ph": "fin",
        "video_mute": "Quitar audio",
        "video_trim_invalid": "Ese intervalo no cabe en el límite; prueba con uno más corto.",
